...
{
	{ .mPixelX = 315, .mPixelY = 138, .mGridX = 0, .mGridY = 0 },
	{ .mPixelX = 397, .mPixelY = 136, .mGridX = 1, .mGridY = 0 },
	{ .mPixelX = 481, .mPixelY = 133, .mGridX = 2, .mGridY = 0 },
	{ .mPixelX = 563, .mPixelY = 138, .mGridX = 3, .mGridY = 0 },
	{ .mPixelX = 648, .mPixelY = 136, .mGridX = 4, .mGridY = 0 },
	{ .mPixelX = 726, .mPixelY = 132, .mGridX = 5, .mGridY = 0 },
	{ .mPixelX = 808, .mPixelY = 135, .mGridX = 6, .mGridY = 0 },
	{ .mPixelX = 890, .mPixelY = 137, .mGridX = 7, .mGridY = 0 },
	{ .mPixelX = 309, .mPixelY = 233, .mGridX = 0, .mGridY = 1 },
	{ .mPixelX = 392, .mPixelY = 230, .mGridX = 1, .mGridY = 1 },
	{ .mPixelX = 474, .mPixelY = 235, .mGridX = 2, .mGridY = 1 },
	{ .mPixelX = 556, .mPixelY = 240, .mGridX = 3, .mGridY = 1 },
	{ .mPixelX = 658, .mPixelY = 238, .mGridX = 4, .mGridY = 1 },
	{ .mPixelX = 739, .mPixelY = 235, .mGridX = 5, .mGridY = 1 },
	{ .mPixelX = 820, .mPixelY = 229, .mGridX = 6, .mGridY = 1 },
	{ .mPixelX = 902, .mPixelY = 233, .mGridX = 7, .mGridY = 1 },
	{ .mPixelX = 283, .mPixelY = 333, .mGridX = 0, .mGridY = 2 },
	{ .mPixelX = 372, .mPixelY = 331, .mGridX = 1, .mGridY = 2 },
	{ .mPixelX = 461, .mPixelY = 325, .mGridX = 2, .mGridY = 2 },
	{ .mPixelX = 552, .mPixelY = 331, .mGridX = 3, .mGridY = 2 },
	{ .mPixelX = 658, .mPixelY = 332, .mGridX = 4, .mGridY = 2 },
	{ .mPixelX = 746, .mPixelY = 326, .mGridX = 5, .mGridY = 2 },
	{ .mPixelX = 836, .mPixelY = 330, .mGridX = 6, .mGridY = 2 },
	{ .mPixelX = 926, .mPixelY = 334, .mGridX = 7, .mGridY = 2 },
	{ .mPixelX = 279, .mPixelY = 436, .mGridX = 0, .mGridY = 3 },
	{ .mPixelX = 366, .mPixelY = 434, .mGridX = 1, .mGridY = 3 },
	{ .mPixelX = 453, .mPixelY = 433, .mGridX = 2, .mGridY = 3 },
	{ .mPixelX = 544, .mPixelY = 434, .mGridX = 3, .mGridY = 3 },
	{ .mPixelX = 667, .mPixelY = 440, .mGridX = 4, .mGridY = 3 },
	{ .mPixelX = 754, .mPixelY = 433, .mGridX = 5, .mGridY = 3 },
	{ .mPixelX = 844, .mPixelY = 430, .mGridX = 6, .mGridY = 3 },
	{ .mPixelX = 933, .mPixelY = 433, .mGridX = 7, .mGridY = 3 }
};

constinit const static SpecialGridPlacement gMushroomGridPlacement[] = {
	{ .mPixelX = 352, .mPixelY = 506, .mGridX = 0, .mGridY = 0 },
	{ .mPixelX = 479, .mPixelY = 425, .mGridX = 1, .mGridY = 0 },
	{ .mPixelX = 540, .mPixelY = 523, .mGridX = 2, .mGridY = 0 },
	{ .mPixelX = 597, .mPixelY = 361, .mGridX = 3, .mGridY = 0 },
	{ .mPixelX = 629, .mPixelY = 268, .mGridX = 4, .mGridY = 0 },
	{ .mPixelX = 702, .mPixelY = 450, .mGridX = 5, .mGridY = 0 },
	{ .mPixelX = 728, .mPixelY = 543, .mGridX = 6, .mGridY = 0 },
	{ .mPixelX = 794, .mPixelY = 348, .mGridX = 7, .mGridY = 0 }
};

constinit const static SpecialGridPlacement gAquariumGridPlacement[] = {
	{ .mPixelX = 355, .mPixelY = 250, .mGridX = 0, .mGridY = 0 },
	{ .mPixelX = 548, .mPixelY = 185, .mGridX = 1, .mGridY = 0 },
	{ .mPixelX = 598, .mPixelY = 335, .mGridX = 2, .mGridY = 0 },
	{ .mPixelX = 864, .mPixelY = 185, .mGridX = 3, .mGridY = 0 },
	{ .mPixelX = 911, .mPixelY = 335, .mGridX = 4, .mGridY = 0 },
	{ .mPixelX = 364, .mPixelY = 420, .mGridX = 5, .mGridY = 0 },
	{ .mPixelX = 607, .mPixelY = 523, .mGridX = 6, .mGridY = 0 },
	{ .mPixelX = 746, .mPixelY = 482, .mGridX = 7, .mGridY = 0 }
};
