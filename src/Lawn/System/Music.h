...
enum MusicFile : int32_t
{
	...
	MUSIC_FILE_ROOF_GRAZETHEROOF,
	MUSIC_FILE_NIGHT_MOONGRAINS,
	MUSIC_FILE_POOL_WATERYGRAVES,
	MUSIC_FILE_FOG_RIGORMORMIST,
	MUSIC_FILE_CHOOSE_YOUR_SEEDS,
	MUSIC_FILE_ZEN_GARDEN,
	MUSIC_FILE_PUZZLE_CEREBRAWL,
	MUSIC_FILE_MINIGAME_LOONBOON,
	MUSIC_FILE_CONVEYER,
	MUSIC_FILE_FINAL_BOSS_BRAINIAC_MANIAC,
	MUSIC_FILE_MAIN_MENU,
